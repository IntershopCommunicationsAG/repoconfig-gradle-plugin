...
|*`activateMavenCentral`* |`boolean`  | `false` |  | If this value is true, mavenCentral will be added to the list of repsoitories. The host of this repository is added to the list of allowed hosts automatically.
